...
Table 1 shows the results of the evaluated 79 antivirus products. Two of these antiviruses scored above 99%. These antiviruses were: ESET-NOD32,	NANO-Antivirus, Comodo, Avira, DrWeb, VBA32, Microsoft, and Cyren. Malware detection indicates that these antivirus programs provide a robust service against cyber-intrusions.
